...
| --- | --- | --- |
| [Adobe Marketing Agent för [!DNL Microsoft 365 Copilot]](ama-ms.md) | Hämta marknadsföringsinsikter från Adobe Experience Platform direkt i [!DNL Microsoft 365] appar som [!DNL Teams], [!DNL Word], [!DNL Powerpoint] och [!DNL Excel]. Med den här agenten kan du underhålla chatthistorik över appar och smidigt fortsätta konversationen medan du arbetar. | |
