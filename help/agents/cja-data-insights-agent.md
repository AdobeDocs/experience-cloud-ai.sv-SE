...
Data Insights Agent, som är tillgängligt från [AI-assistenten](/help/ai-assistant/ai-assistant-ui.md), är en generativ AI-konversationsagent som snabbt och effektivt besvarar frågor om dina data. Det bygger upp relevanta visualiseringar i Analysis Workspace med komponenter från datavyn och era faktiska data.
...
![Data Insights Agent i AI-assistenten](/help/agents/images/cja-agent/cja-ai-asst-da.gif)
...
* **Behörigheter**: Nödvändiga behörigheter måste beviljas i [!UICONTROL Adobe Admin Console] innan användare kan komma åt Data Insights Agent.
  ...
  Om du vill bevilja behörigheter måste en [produktprofiladministratör](https://helpx.adobe.com/enterprise/using/manage-product-profiles.html) utföra följande steg i [!UICONTROL Admin Console]:
   ...
   1. Välj fliken **[!UICONTROL Permissions]** i den specifika produktprofilen.
      ...
      ![Fliken Behörigheter i Admin Console](/help/agents/images/cja-agent/ai-assistant-permissions-tab.png)

   1. Markera redigeringsikonen **[!UICONTROL Reporting Tools]** Redigera![ på raden ](/help/agents/images/cja-agent/Edit.svg) i den angivna tabellen.
   1. Bläddra till eller sök efter **[!UICONTROL AI Assistant: Product Knowledge]** och välj sedan plusikonen ![AddCircle](/help/agents/images/cja-agent/AddCircle.svg) bredvid den här behörigheten.
   1. Bläddra till eller sök efter **[!UICONTROL Data Insights Agent]** och välj sedan plusikonen ![AddCircle](/help/agents/images/cja-agent/AddCircle.svg) bredvid den här behörigheten.
      ...
      ![Lägg till behörighet](/help/agents/images/cja-agent/ai-assistant-permissions.png).
...
* **Datavyåtkomst**: Datavyer måste aktiveras för Data Insights Agent.
  ...
  Så här visar du antalet datavyer som har aktiverats för Data Insights Agent i din IMS-organisation:
   ...
   1. Välj informationsikonen högst upp i kolumnen **[!UICONTROL Data Insights Agent]**.
      ...
      ![Data Insights Agent informationsikon](/help/agents/images/cja-agent/data-insights-agent-tooltip.png)
...
5. Välj ikonen för AI Assistant-chatt längst upp till höger på sidan.
   ...
   * Datavy Tools: **[!UICONTROL Data Insights Agent]**
   ...
   ![AI Assistant-ikon](/help/agents/images/cja-agent/ai-asst-icon.png)
...
![AI-fråga](/help/agents/images/cja-agent/ai-asst-prompt1.png)
...
![Svar på fråga - linjediagram och frihandstabell](/help/agents/images/cja-agent/ai-asst-result.png)
...
![Stapeldiagram](/help/agents/images/cja-agent/ai-asst-result2.png)
...
![Stapeldiagram](/help/agents/images/cja-agent/ai-asst-result4.png)
...
![Ring](/help/agents/images/cja-agent/ai-asst-result3.png)
